...
library(dplyr) # for mutate and pull
library(grid) # for x - axis tick lengths
...
ui <- fluidPage(
  ...
  tabsetPanel(type = "tabs",
              ...
              tabPanel("Information",
                       "This interactive tool allows the user to visually and numerically interrogate the distributions of rank sums that underpin the Mann-Whitney Test and Wilcoxon Signed Rank Test.",
                       br(),
                       br(),
                       "In the Scottish Qualification Authority's publication 'Statistics Advanced Higher - Statistical Formulae and Tables', Tables 7 and 8 list the critical values for these two tests.",
                       br(),
                       br(),
                       strong("Teaching suggestion:"),
                       br(),
                       "After covering the introduction to the process for each test from first principals, use this interactive tool to gain a broader appreciation of the shape of each family of distributions, and how the information in Tables 7 and 8 is derived from them.",
                       br(),
                       "The user can also explore how well the one and two tailed probabilities for the rank sum test statistic align with the critical values. The discrete nature of the rank sums is the source of any differences.",
                       br(),
                       br(),
                       strong("Caution"),
                       br(),
                       "Larger sample sizes can generate distributions with so many data points that it can lead to reduced performance issues and truncated graphics.",
                       br(),
                       br(),
                       strong("Historical Notes"),
                       br(),
                       "Henry Mann (1905-2000) was Austrian, emigrated to the United States of America and was ultimately Professor of Mathematics and Statistics at Ohio State University.
Donald Whitney (1915—2001) was an American Statistician who was a student of Henry Mann.
They published their Mann-Whitney Test in 1947, originally just for sample sizes up to m = n = 8.",
br(),
br(),
"Frank Wilcoxon (1892-1965) was an Irish American Chemist and Statistician who was working at the American Cyanamid Company when he published his Signed Rank Test in 1945.
Wilcoxon's original publication did not address the question of differences that equal zero. However, in later surveys, he recommended removing zeros from the sample."
              )
  )
)# end of fluidPage
